...
const KaioTokenCrowdsale = artifacts.require('KaioTokenCrowdsale');
const KaioToken = artifacts.require('KaioToken');
...
contract('Crowdsale', function ([owner, wallet, investor]) {
  ...
  beforeEach(async function () {
    ...
    this.crowdsale = await KaioTokenCrowdsale.new(this.startTime, this.endTime, RATE, GOAL, CAP, wallet);
    this.token = KaioToken.at(await this.crowdsale.token());
  });
